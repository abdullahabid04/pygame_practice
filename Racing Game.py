import math
import time
from Projects.Pygame.utilities import scale_image, blit_rotate_center, blit_text_center
import pygame
...
pygame.display.set_caption("R A C I N G   G A M E")

images = [(GRASS, (0, 0)), (TRACK, (0, 0)), (FINISH, FINISH_POS), (TRACK_BORDER, (0, 0))]

PATH = [(171, 116), (103, 70), (62, 134), (71, 482), (319, 724), (405, 660), (420, 518), (519, 465), (590, 540), (614, 714), (736, 710), (729, 385), (583, 348), (402, 345), (457, 246), (711, 250), (733, 91), (571, 68), (305, 82), (274, 376), (175, 395), (160, 250)]
...
def draw(win, images, player_car, computer_car, game_info):
    ...
    time_text = MAIN_FONT.render(f"Time : {game_info.get_level_time()} s ", True, (255, 255, 255))
    win.blit(time_text, (10, HEIGHT - time_text.get_height() - 40))

    velocity_text = MAIN_FONT.render(f"Velocity {round(player_car.vel, 1)} px/s ", True, (255, 255, 255))
